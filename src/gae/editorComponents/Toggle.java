...
/**
 * This class is to set up a toggle button for the editors
 * This class can be extended to add multiple buttons and group them together
 * Possibly add a persistent toggle group (where one button is always selected) in the future
